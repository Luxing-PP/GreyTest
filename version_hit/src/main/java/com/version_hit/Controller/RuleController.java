...
//127.0.0.1:8080/version/rule?aid=1&platform=2&download_url=3&update_version_code=4&md5=5&device_id_list=6&max_update_version_code=7&min_update_version_code=8&max_os_api=9&min_os_api=10&cpu_arch=1&channel=2&title=3&update_tips=4
    @GetMapping("/rule")
...
//                       @RequestParam("device_id_list") String device_id_list,
    ...
    @GetMapping("/suspend")
    public  String suspendRule(@RequestParam("id") String id,
                                @RequestParam("status") String status){
        Response response=ruleService.suspendRule(id,status);
        return response.getMessage();
    }
